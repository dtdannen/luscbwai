...
class CombatCommander
{
	...
	void				assignTankSquads(std::set<BWAPI::Unit *> & combatUnits);
	void				assignGoliathSquads(std::set<BWAPI::Unit *> & combatUnits);
	void				assignVultureSquads(std::set<BWAPI::Unit *> & combatUnits);
